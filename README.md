...
The 'bank_core_data' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/bank_core_data/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] bank_core_data_etl` to your workspace.
